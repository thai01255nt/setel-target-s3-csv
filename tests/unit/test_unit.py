...
class TestUnit(unittest.TestCase):
    ...
    def test_config_validation(self):
        ...
        validator = setel_target_s3_csv.utils.validate_config
        empty_config = {}
        minimal_config = {
    ...
    def test_naming_convention_replaces_tokens(self):
        ...
        s3_key = setel_target_s3_csv.utils.get_target_key(message, timestamp=timestamp, naming_convention='test_{stream}_{timestamp}_test.csv')
    ...
    def test_naming_convention_has_reasonable_default(self):
        ...
        s3_key = setel_target_s3_csv.utils.get_target_key(message)
    ...
    def test_naming_convention_honors_prefix(self):
        ...
        s3_key = setel_target_s3_csv.utils.get_target_key(message, prefix='the_prefix__', naming_convention='folder1/test_{stream}_test.csv')
